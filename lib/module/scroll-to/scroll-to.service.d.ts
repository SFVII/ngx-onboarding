...
export declare class ScrollToService {
     ...
     * @returns               Observable
     */
    start(options: ScrollToConfigOptions): Observable<number>;
    /**
     ...
     * @returns                       Void
     */
    subscribeToAnimation(animation$: Observable<any>, listenerTarget: ScrollToListenerTarget, onInterrupt: EventListenerOrEventListenerObject): void;
    /**
