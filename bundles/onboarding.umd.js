(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common/http'), require('@angular/core'), require('rxjs'), require('@angular/router'), require('@angular/forms'), require('@angular/cdk/keycodes'), require('@angular/material/form-field'), require('@angular/material/select'), require('@angular/material/core'), require('@angular/material/checkbox'), require('@angular/material/button'), require('@angular/material/chips'), require('@angular/material/icon'), require('@angular/material/input'), require('@angular/common'), require('@angular/material/paginator'), require('@angular/material/sort'), require('@angular/material/table'), require('@angular/platform-browser'), require('@angular/platform-browser/animations'), require('@angular/material/radio'), require('@angular/material/grid-list'), require('@angular/cdk/table')) :
    typeof define === 'function' && define.amd ? define('onboarding', ['exports', '@angular/common/http', '@angular/core', 'rxjs', '@angular/router', '@angular/forms', '@angular/cdk/keycodes', '@angular/material/form-field', '@angular/material/select', '@angular/material/core', '@angular/material/checkbox', '@angular/material/button', '@angular/material/chips', '@angular/material/icon', '@angular/material/input', '@angular/common', '@angular/material/paginator', '@angular/material/sort', '@angular/material/table', '@angular/platform-browser', '@angular/platform-browser/animations', '@angular/material/radio', '@angular/material/grid-list', '@angular/cdk/table'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.onboarding = {}, global.ng.common.http, global.ng.core, global.rxjs, global.ng.router, global.ng.forms, global.ng.cdk.keycodes, global.ng.material.formField, global.ng.material.select, global.ng.material.core, global.ng.material.checkbox, global.ng.material.button, global.ng.material.chips, global.ng.material.icon, global.ng.material.input, global.ng.common, global.ng.material.paginator, global.ng.material.sort, global.ng.material.table, global.ng.platformBrowser, global.ng.platformBrowser.animations, global.ng.material.radio, global.ng.material.gridList, global.ng.cdk.table));
})(this, (function (exports, i1, i0, rxjs, i3, i1$1, keycodes, i4, i5, i6, i7, i8, i9, i10, i11, i12, paginator, sort, table, platformBrowser, animations, radio, gridList, table$1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    OnboardingService.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.13", ngImport: i0__namespace, type: OnboardingService, deps: [{ token: i1__namespace.HttpClient }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    OnboardingService.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.13", ngImport: i0__namespace, type: OnboardingService, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.13", ngImport: i0__namespace, type: OnboardingService, decorators: [{
                type: i0.Injectable,
    ...
    OnboardingComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.13", ngImport: i0__namespace, type: OnboardingComponent, deps: [{ token: OnboardingService }], target: i0__namespace.ɵɵFactoryTarget.Component });
    OnboardingComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.13", type: OnboardingComponent, selector: "ngx-onboarding", ngImport: i0__namespace, template: "<!-- <onboarding-create-profile-template></onboarding-create-profile-template> -->\n<router-outlet></router-outlet>", directives: [{ type: i3__namespace.RouterOutlet, selector: "router-outlet", outputs: ["activate", "deactivate"], exportAs: ["outlet"] }] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.13", ngImport: i0__namespace, type: OnboardingComponent, decorators: [{
                type: i0.Component,
                args: [{
            ...
            }], ctorParameters: function () { return [{ type: OnboardingService }]; } });
                    ...
                    switch (_c.label) {
                        case 0:
                            this.form = this.fb.group({
                                ...
                                Description: [''],
                                Tags: ['', i1$1.Validators.required],
                                Status: [false, i1$1.Validators.required]
                            });
                            _a = this;
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.13", ngImport: i0__namespace, type: CreateProfileTemplateComponent, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i1__namespace$1.FormBuilder }, { type: OnboardingService }, { type: i3__namespace.ActivatedRoute }, { type: i3__namespace.Router }]; } });
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.13", ngImport: i0__namespace, type: ProfileListComponent, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: OnboardingService }, { type: i3__namespace.Router }]; }, propDecorators: { paginator: [{
                    type: i0.ViewChild,
    ...
    OnboardingModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.13", ngImport: i0__namespace, type: OnboardingModule, deps: [{ token: OnboardingModule, optional: true, skipSelf: true }], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    OnboardingModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.13", ngImport: i0__namespace, type: OnboardingModule, declarations: [OnboardingComponent, CreateProfileTemplateComponent, ProfileListComponent], imports: [i1$1.FormsModule,
            i1.HttpClientModule,
            ...
            sort.MatSortModule,
            table.MatTableModule, i3__namespace.RouterModule], exports: [OnboardingComponent, i1.HttpClientModule, CreateProfileTemplateComponent, ProfileListComponent, OnboardingComponent] });
    OnboardingModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.13", ngImport: i0__namespace, type: OnboardingModule, providers: [OnboardingService], imports: [[
                i1$1.FormsModule,
                i1.HttpClientModule,
                i4.MatFormFieldModule,
                i8.MatButtonModule,
                ...
                i3.RouterModule.forRoot(routes)
            ], i1.HttpClientModule] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.13", ngImport: i0__namespace, type: OnboardingModule, decorators: [{
                type: i0.NgModule,
                args: [{
