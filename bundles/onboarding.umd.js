...
}(this, (function (exports, http, core, rxjs, forms, keycodes, router, paginator, sort, table, common, platformBrowser, animations, input, select, icon, button, formField, checkbox, radio, chips, gridList, table$1) { 'use strict';
    ...
    var OnboardingModule = /** @class */ (function () {
        ...
        OnboardingModule = OnboardingModule_1 = __decorate([
            core.NgModule({
                ...
                exports: [OnboardingComponent, http.HttpClientModule, CreateProfileTemplateComponent, ProfileListComponent, OnboardingComponent, forms.FormsModule,
                    http.HttpClientModule,
                    formField.MatFormFieldModule,
                    button.MatButtonModule,
                    common.CommonModule,
