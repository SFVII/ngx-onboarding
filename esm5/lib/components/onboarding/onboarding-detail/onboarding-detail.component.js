...
function OnboardingDetailComponent_div_0_li_22_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵclassMap(i_r937 === 0 ? "active" : "");
    i0.ɵɵproperty("ngxScrollTo", "#" + category_r936.name)("id", category_r936.name + "x");
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(category_r936.name);
} }
...
function OnboardingDetailComponent_div_0_section_24_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    var category_r938 = i0.ɵɵnextContext().$implicit;
    var ctx_r941 = i0.ɵɵnextContext(2);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate1("", ctx_r941.progress(category_r938 == null ? null : category_r938.fieldCompleted, category_r938 == null ? null : category_r938.fieldLength), "% Termin\u00E9");
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("value", ctx_r941.progress(category_r938 == null ? null : category_r938.fieldCompleted, category_r938 == null ? null : category_r938.fieldLength));
} }
...
function OnboardingDetailComponent_div_0_section_24_Template(rf, ctx) { if (rf & 1) {
    ...
    var ctx_r933 = i0.ɵɵnextContext(2);
    i0.ɵɵproperty("id", category_r938.name);
    i0.ɵɵadvance(5);
    i0.ɵɵtextInterpolate(category_r938.name);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate1(" Listes des informations n\u00E9cessaires pour la cr\u00E9ation de ", ctx_r933.catNameStart(category_r938.name) ? "l'" + category_r938.name : category_r938.name, " ");
    i0.ɵɵadvance(2);
    i0.ɵɵproperty("ngIf", (category_r938 == null ? null : category_r938.fieldCompleted) === (category_r938 == null ? null : category_r938.fieldLength));
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngIf", (category_r938 == null ? null : category_r938.fieldCompleted) < (category_r938 == null ? null : category_r938.fieldLength));
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngForOf", category_r938.forms);
} }
...
function OnboardingDetailComponent_div_0_ng_container_30_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngForOf", ctx_r934.detailView.tickets);
} }
...
function OnboardingDetailComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function OnboardingDetailComponent_div_0_Template_mat_icon_click_4_listener() { i0.ɵɵrestoreView(_r966); var ctx_r965 = i0.ɵɵnextContext(); return ctx_r965.onEdit(); });
    i0.ɵɵtext(5, "edit");
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵlistener("scroll", function OnboardingDetailComponent_div_0_Template_div_scroll_23_listener($event) { i0.ɵɵrestoreView(_r966); var ctx_r967 = i0.ɵɵnextContext(); return ctx_r967.onScroll($event); });
    ...
    i0.ɵɵadvance(3);
    i0.ɵɵtextInterpolate1("Int\u00E9gration profil ", ctx_r931.detailView == null ? null : ctx_r931.detailView.Name, "");
    i0.ɵɵadvance(8);
    i0.ɵɵtextInterpolate2("", ctx_r931.detailView.user.FirstName, " ", ctx_r931.detailView.user.LastName, "");
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(i0.ɵɵpipeBind2(14, 10, ctx_r931.detailView.createdAt, "dd/MM/yy"));
    i0.ɵɵadvance(4);
    i0.ɵɵtextInterpolate(ctx_r931.detailView == null ? null : ctx_r931.detailView.user == null ? null : ctx_r931.detailView.user.Phone == null ? null : ctx_r931.detailView.user.Phone.internationalNumber);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(ctx_r931.detailView.user.Email);
    i0.ɵɵadvance(3);
    i0.ɵɵproperty("ngForOf", ctx_r931.detailView.categories);
    i0.ɵɵadvance(2);
    i0.ɵɵproperty("ngForOf", ctx_r931.detailView.categories);
    i0.ɵɵadvance(6);
    i0.ɵɵproperty("ngIf", ctx_r931.detailView.tickets && ctx_r931.detailView.tickets.length > 0);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngIf", !ctx_r931.detailView.tickets);
} }
