...
function TypeComponent_button_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function TypeComponent_button_1_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r528); var item_r526 = ctx.$implicit; var ctx_r527 = i0.ɵɵnextContext(); return ctx_r527.onSelect(item_r526.value); });
    i0.ɵɵtext(1);
    ...
    i0.ɵɵclassMap(ctx_r525.selectedType === item_r526.value ? "active" : "");
    i0.ɵɵadvance(1);
    i0.ɵɵtextInterpolate1(" ", item_r526.label, " ");
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(item_r526.icon);
} }
