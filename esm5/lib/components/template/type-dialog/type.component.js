...
function TypeComponent_button_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function TypeComponent_button_1_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r564); var item_r562 = ctx.$implicit; var ctx_r563 = i0.ɵɵnextContext(); return ctx_r563.onSelect(item_r562.value); });
    i0.ɵɵtext(1);
    ...
    var ctx_r561 = i0.ɵɵnextContext();
    i0.ɵɵclassMap(ctx_r561.selectedType === item_r562.value ? "active" : "");
    i0.ɵɵadvance(1);
    i0.ɵɵtextInterpolate1(" ", item_r562.label, " ");
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(item_r562.icon);
} }
