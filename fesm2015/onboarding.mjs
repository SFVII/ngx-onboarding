...
OnboardingComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: OnboardingComponent, selectors: [["ngx-onboarding"]], decls: 2, vars: 0, template: function OnboardingComponent_Template(rf, ctx) {
        if (rf & 1) {
...
OnboardingListComponent.ɵfac = function OnboardingListComponent_Factory(t) { return new (t || OnboardingListComponent)(i0.ɵɵdirectiveInject(OnboardingService), i0.ɵɵdirectiveInject(i2$1.Router), i0.ɵɵdirectiveInject(i2$1.ActivatedRoute), i0.ɵɵdirectiveInject(i1$1.MatDialog), i0.ɵɵdirectiveInject(i4.DatePipe)); };
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(OnboardingListComponent, [{
        ...
        }], function () { return [{ type: OnboardingService }, { type: i2$1.Router }, { type: i2$1.ActivatedRoute }, { type: i1$1.MatDialog }, { type: i4.DatePipe }]; }, null);
})();
