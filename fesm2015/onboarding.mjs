...
import * as i6$1 from 'ngx-filter';
import { FilterModule } from 'ngx-filter';
import * as i7$2 from 'nowboard-icon';
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(OnboardingModule, { declarations: [MaterialElevationDirective,
            ...
            CdkTableModule,
            MatSortModule,
            MatTableModule, i2.RouterModule, i5$2.ScrollToModule, i6$1.FilterModule, DragDropModule,
            MatCardModule,
            MatDialogModule,
            MatStepperModule,
            MatProgressBarModule,
