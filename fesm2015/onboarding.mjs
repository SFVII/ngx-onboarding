...
function TemplateProfileListComponent_div_1_section_15_lib_loading_page_16_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelement(0, "lib-loading-page");
    }
}
function TemplateProfileListComponent_div_1_section_15_mat_icon_17_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelementStart(0, "mat-icon");
...
function TemplateProfileListComponent_div_1_section_15_Template(rf, ctx) {
    if (rf & 1) {
...
function TemplateProfileListComponent_div_1_div_17_lib_loading_page_16_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelement(0, "lib-loading-page");
    }
}
function TemplateProfileListComponent_div_1_div_17_mat_icon_17_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelementStart(0, "mat-icon");
        i0.ɵɵtext(1, "filter_none");
        i0.ɵɵelementEnd();
...
function TemplateProfileListComponent_div_1_div_17_Template(rf, ctx) {
    if (rf & 1) {
...
function OnboardingListComponent_div_20_Template(rf, ctx) {
    if (rf & 1) {
...
OnboardingListComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: OnboardingListComponent, selectors: [["lib-onboarding-list"]], decls: 21, vars: 9, consts: [[1, "main-all-ticket-list", "onboarding-list-container"], [1, "header-top"], [2, "margin", "0"], ["role", "button", "mat-raised-button", "", "color", "primary", 1, "add-onboarding", 3, "click"], [1, "list-title"], ["searchType", "search-group", "lang", "fr", 3, "filterConfig", "datas", "withRefresh", "onFilter", "onRefresh"], [1, "right-action"], [1, "filter-item"], ["mat-flat-button", "", "appearance", "text", 1, "export-to-csv", "rounded", "secondary", "download-btn", "mr30", 3, "click"], [1, "mr5", 3, "icon", "size"], ["searchType", "search-text", "lang", "fr", 3, "datas", "onFilter"], [1, "content-view-list-ticket"], [1, "header-result"], [4, "ngIf"], [3, "columnDefinitions", "data", "lang", "inputSearch"]], template: function OnboardingListComponent_Template(rf, ctx) {
        if (rf & 1) {
