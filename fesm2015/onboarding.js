...
function ProfileListComponent_div_13_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("click", function ProfileListComponent_div_13_Template_button_click_6_listener($event) { ɵɵrestoreView(_r186); const d_r180 = ctx.$implicit; const ctx_r185 = ɵɵnextContext(); return ctx_r185.onDelete($event, d_r180._id); });
