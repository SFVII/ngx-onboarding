...
function OnboardingDetailComponent_div_0_li_22_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵclassMap(i_r467 === 0 ? "active" : "");
    i0.ɵɵproperty("ngxScrollTo", "#" + category_r466.name)("id", category_r466.name + "x");
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(category_r466.name);
} }
...
function OnboardingDetailComponent_div_0_section_24_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    const category_r468 = i0.ɵɵnextContext().$implicit;
    const ctx_r471 = i0.ɵɵnextContext(2);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate1("", ctx_r471.progress(category_r468 == null ? null : category_r468.fieldCompleted, category_r468 == null ? null : category_r468.fieldLength), "% Termin\u00E9");
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("value", ctx_r471.progress(category_r468 == null ? null : category_r468.fieldCompleted, category_r468 == null ? null : category_r468.fieldLength));
} }
function OnboardingDetailComponent_div_0_section_24_div_11_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const forms_r474 = i0.ɵɵnextContext().$implicit;
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(forms_r474.label);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(forms_r474.value);
} }
function OnboardingDetailComponent_div_0_section_24_div_11_ng_container_2_div_3_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const sub_r479 = i0.ɵɵnextContext().$implicit;
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(sub_r479.label);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(sub_r479.value);
} }
function OnboardingDetailComponent_div_0_section_24_div_11_ng_container_2_div_3_ng_container_2_div_3_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const child_r484 = i0.ɵɵnextContext().$implicit;
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(child_r484.label);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(child_r484.value);
} }
function OnboardingDetailComponent_div_0_section_24_div_11_ng_container_2_div_3_ng_container_2_div_3_ng_container_2_div_3_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(c2_r489.label);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(c2_r489.value);
} }
function OnboardingDetailComponent_div_0_section_24_div_11_ng_container_2_div_3_ng_container_2_div_3_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtextInterpolate(child_r484.label);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngForOf", child_r484.forms);
} }
function OnboardingDetailComponent_div_0_section_24_div_11_ng_container_2_div_3_ng_container_2_div_3_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngIf", !child_r484.forms);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngIf", child_r484.forms);
} }
function OnboardingDetailComponent_div_0_section_24_div_11_ng_container_2_div_3_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtextInterpolate(sub_r479.label);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngForOf", sub_r479.forms);
} }
function OnboardingDetailComponent_div_0_section_24_div_11_ng_container_2_div_3_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngIf", !sub_r479.forms);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngIf", sub_r479.forms);
} }
function OnboardingDetailComponent_div_0_section_24_div_11_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtextInterpolate(forms_r474.label);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngForOf", forms_r474.forms);
} }
function OnboardingDetailComponent_div_0_section_24_div_11_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngIf", !forms_r474.forms);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngIf", forms_r474.forms);
} }
function OnboardingDetailComponent_div_0_section_24_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵproperty("id", category_r468.name);
    i0.ɵɵadvance(5);
    i0.ɵɵtextInterpolate(category_r468.name);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate1(" Listes des informations n\u00E9cessaires pour la cr\u00E9ation de ", ctx_r463.catNameStart(category_r468.name) ? "l'" + category_r468.name : category_r468.name, " ");
    i0.ɵɵadvance(2);
    i0.ɵɵproperty("ngIf", (category_r468 == null ? null : category_r468.fieldCompleted) === (category_r468 == null ? null : category_r468.fieldLength));
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngIf", (category_r468 == null ? null : category_r468.fieldCompleted) < (category_r468 == null ? null : category_r468.fieldLength));
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngForOf", category_r468.forms);
} }
function OnboardingDetailComponent_div_0_ng_container_30_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(i0.ɵɵpipeBind2(3, 4, ticket_r494.CreatedDate, "dd/MM/yy"));
    i0.ɵɵadvance(4);
    i0.ɵɵtextInterpolate(ticket_r494.Subject);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(ticket_r494.Status);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(ticket_r494.Description);
} }
function OnboardingDetailComponent_div_0_ng_container_30_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngForOf", ctx_r464.detailView.tickets);
} }
...
function OnboardingDetailComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function OnboardingDetailComponent_div_0_Template_mat_icon_click_4_listener() { i0.ɵɵrestoreView(_r496); const ctx_r495 = i0.ɵɵnextContext(); return ctx_r495.onEdit(); });
    i0.ɵɵtext(5, "edit");
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵlistener("scroll", function OnboardingDetailComponent_div_0_Template_div_scroll_23_listener($event) { i0.ɵɵrestoreView(_r496); const ctx_r497 = i0.ɵɵnextContext(); return ctx_r497.onScroll($event); });
    ...
    i0.ɵɵadvance(3);
    i0.ɵɵtextInterpolate1("Int\u00E9gration profil ", ctx_r461.detailView == null ? null : ctx_r461.detailView.Name, "");
    i0.ɵɵadvance(8);
    i0.ɵɵtextInterpolate2("", ctx_r461.detailView.user.FirstName, " ", ctx_r461.detailView.user.LastName, "");
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(i0.ɵɵpipeBind2(14, 10, ctx_r461.detailView.createdAt, "dd/MM/yy"));
    i0.ɵɵadvance(4);
    i0.ɵɵtextInterpolate(ctx_r461.detailView == null ? null : ctx_r461.detailView.user == null ? null : ctx_r461.detailView.user.Phone == null ? null : ctx_r461.detailView.user.Phone.internationalNumber);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(ctx_r461.detailView.user.Email);
    i0.ɵɵadvance(3);
    i0.ɵɵproperty("ngForOf", ctx_r461.detailView.categories);
    i0.ɵɵadvance(2);
    i0.ɵɵproperty("ngForOf", ctx_r461.detailView.categories);
    i0.ɵɵadvance(6);
    i0.ɵɵproperty("ngIf", ctx_r461.detailView.tickets && ctx_r461.detailView.tickets.length > 0);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngIf", !ctx_r461.detailView.tickets);
} }
