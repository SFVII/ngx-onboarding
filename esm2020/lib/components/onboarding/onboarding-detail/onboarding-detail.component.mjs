...
function OnboardingDetailComponent_ng_container_34_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function OnboardingDetailComponent_ng_container_34_div_1_Template_button_click_2_listener() { const restoredCtx = i0.ɵɵrestoreView(_r57); const ticket_r55 = restoredCtx.$implicit; const ctx_r56 = i0.ɵɵnextContext(2); return ctx_r56.onViewTicket(ticket_r55.CaseNumber); });
